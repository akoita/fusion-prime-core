"""
Observability middleware for Compliance Service.
"""
...
def configure_observability(app, service_name: str = "compliance"):
    """Configure observability for the Compliance Service."""
...
class LoggingMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: ASGIApp, service_name: str = "compliance"):
        super().__init__(app)
...
def get_logger(name: str, service: str = "compliance") -> logging.Logger:
