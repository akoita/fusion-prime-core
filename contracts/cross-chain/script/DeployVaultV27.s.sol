...
import "../src/CrossChainVaultV27.sol";

/**
 * @title DeployVaultV27
 * @notice Deploys CrossChainVaultV27 with ALL cross-chain messaging disabled
 * @dev Usage:
 *   PRIVATE_KEY=<key> forge script script/DeployVaultV27.s.sol:DeployVaultV27 \
 *     --rpc-url <rpc-url> --broadcast
 */
contract DeployVaultV27 is Script {
    ...
    function run() external {
        ...
        console.log("Deploying CrossChainVaultV27 with deployer:", deployer);
        console.log("Chain ID:", block.chainid);

        vm.startBroadcast(deployerPrivateKey);

        CrossChainVaultV27 vault;
        ...
        if (block.chainid == 11155111) {
            ...
            console.log("CrossChainVaultV27:", address(vault));
