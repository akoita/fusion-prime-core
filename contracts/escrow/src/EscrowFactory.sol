...
import {EscrowDeployed} from "./Events.sol";
import {InvalidParameters, DeploymentFailed} from "./Errors.sol";
...
contract EscrowFactory {
        ...
        returns (address escrow)
    {
        ...
        emit EscrowDeployed(escrow, msg.sender, payee, msg.value, releaseDelay, approvalsRequired);
    }
