...
contract EscrowFactoryTest is Test {
    ...
    function testCreateEscrow() public {
        vm.prank(payer);
        address escrowAddr = factory.createEscrow{value: AMOUNT}(payee, 1 days, 2, address(0));
    ...
    function testCreateMultipleEscrows() public {
        ...
        address escrow1 = factory.createEscrow{value: AMOUNT}(payee, 1 days, 2, address(0));
        address escrow2 = factory.createEscrow{value: AMOUNT}(address(0x4), 2 days, 1, address(0));
    ...
    function testCreateEscrowDeterministic() public {
        ...
        address predicted = factory.computeEscrowAddress(payer, payee, 1 days, 2, address(0), salt);

        // Deploy with CREATE2
        vm.prank(payer);
        address escrowAddr = factory.createEscrowDeterministic{value: AMOUNT}(payee, 1 days, 2, address(0), salt);
    ...
    function testDeterministicAddressComputation() public {
        ...
        address predicted1 = factory.computeEscrowAddress(payer, payee, 1 days, 2, address(0), salt1);

        address predicted2 = factory.computeEscrowAddress(payer, payee, 1 days, 2, address(0), salt2);
        ...
        // Deploy with salt1
        vm.prank(payer);
        address deployed = factory.createEscrowDeterministic{value: AMOUNT}(payee, 1 days, 2, address(0), salt1);
