...
import {BridgeManager} from "cross-chain/BridgeManager.sol";
import {CCIPAdapter} from "cross-chain/adapters/CCIPAdapter.sol";
...
contract FixCCIPSelector is Script {
    ...
    uint64 constant CCIP_SELECTOR_AMOY = 16281711391670634445; // ← CORRECTED
    ...
    function run() external {
        ...
        CCIPAdapter newCcipAdapter = new CCIPAdapter(CCIP_ROUTER_SEPOLIA, chainSelectors, chainNames);
