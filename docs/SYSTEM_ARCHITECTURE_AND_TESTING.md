...
**File**: `test_system_integration.py::test_pubsub_integration`

**What it tests**:
- Blockchain metrics (chain ID, latest block, connectivity)
- Service metrics (status, health for each service)
...
### **Locally (Against Deployed Services)**

```bash
# Set environment variables
export ETH_RPC_URL="http://localhost:8545"
export CHAIN_ID="31337"
export SETTLEMENT_SERVICE_URL="https://settlement-service-961424092563.us-central1.run.app"
export RISK_ENGINE_SERVICE_URL="https://risk-engine-service-961424092563.us-central1.run.app"
export COMPLIANCE_SERVICE_URL="https://compliance-service-961424092563.us-central1.run.app"
export RELAYER_SERVICE_URL="https://event-relayer-961424092563.us-central1.run.app"
...
# Run specific test
python -m pytest test_system_integration.py::TestSystemIntegration::test_end_to_end_workflow -v
```

### **Via GitHub Actions**

Tests run automatically after each successful deployment via the `testnet-validation.yml` workflow.

**Manual trigger**:
```bash
gh workflow run testnet-validation.yml \
  -f environment=dev \
...
- ✅ Services handle degraded mode gracefully
- ✅ Complete workflow simulation succeeds

### **Metrics Collected**
- ✅ Blockchain metrics available
...
- **[CI_CD_STATUS.md](./CI_CD_STATUS.md)** - CI/CD pipeline status
- **[TESTNET_VALIDATION_SETUP.md](./TESTNET_VALIDATION_SETUP.md)** - Test setup guide
- **[docs/specification.md](./docs/specification.md)** - System specification
- **[services/README.md](./services/README.md)** - Service overview
- **[integrations/README.md](./integrations/README.md)** - Integration overview

---

**Status**: ✅ Tests ready and operational
**Last Test Run**: Pending (run via GitHub Actions)
